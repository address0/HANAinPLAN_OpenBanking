package com.hanainplan.hana.subscription.controller;
...
import com.hanainplan.hana.subscription.service.InsuranceSubscriptionService;
...
@RestController
@RequestMapping("/api/hana/subscriptions")
@RequiredArgsConstructor
@Tag(name = "HANA 보험 가입 관리", description = "HANA 보험사의 보험 가입 CRUD API")
