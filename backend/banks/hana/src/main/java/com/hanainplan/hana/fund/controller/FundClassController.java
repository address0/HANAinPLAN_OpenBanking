...
import com.hanainplan.hana.fund.service.FundClassService;
...
/**
 * 하나은행 펀드 클래스 컨트롤러 (실제 구조)
 */
@RestController
@RequestMapping("/api/hana/fund-classes")
@RequiredArgsConstructor
@Slf4j
@Tag(name = "Hana Fund Classes", description = "하나은행 펀드 클래스 API (실제 구조)")
public class FundClassController {
    ...
    public ResponseEntity<List<FundClassDetailDto>> getAllOnSaleFundClasses() {
        log.info("GET /api/hana/fund-classes - 판매중인 펀드 클래스 목록 조회");
    ...
    public ResponseEntity<FundClassDetailDto> getFundClass(
        ...
        log.info("GET /api/hana/fund-classes/{} - 펀드 클래스 상세 조회", childFundCd);
    ...
    public ResponseEntity<List<FundClassDetailDto>> getFundClassesByMaster(
        ...
        log.info("GET /api/hana/fund-classes/master/{} - 모펀드의 클래스 목록 조회", fundCd);
    ...
    public ResponseEntity<List<FundClassDetailDto>> getFundClassesByAssetType(
        ...
        log.info("GET /api/hana/fund-classes/asset-type/{} - 자산 유형별 조회", assetType);
    ...
    public ResponseEntity<List<FundClassDetailDto>> getFundClassesByClassCode(
        ...
        log.info("GET /api/hana/fund-classes/class-code/{} - 클래스 코드별 조회", classCode);
    ...
    public ResponseEntity<List<FundClassDetailDto>> getFundClassesByMaxAmount(
        ...
        log.info("GET /api/hana/fund-classes/max-amount/{} - 최소 투자금액 이하 펀드 조회", maxAmount);
