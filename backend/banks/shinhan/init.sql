...
-- 금리 정보 테이블
CREATE TABLE IF NOT EXISTS shinhan_interest_rates (
...
-- 예금 가입 정보 테이블
CREATE TABLE IF NOT EXISTS shinhan_product_subscriptions (
...
-- 신한은행 정기예금 금리 데이터 (상품유형 0: 일반 정기예금)
INSERT INTO shinhan_interest_rates (product_code, interest_type, maturity_period, interest_rate, effective_date) VALUES
('SHINHAN_DEPOSIT_001', 'BASIC', '6개월', 0.0198, '2025-01-01'),
('SHINHAN_DEPOSIT_001', 'BASIC', '1년', 0.0233, '2025-01-01'),
('SHINHAN_DEPOSIT_001', 'BASIC', '2년', 0.0197, '2025-01-01'),
('SHINHAN_DEPOSIT_001', 'BASIC', '3년', 0.0202, '2025-01-01'),
('SHINHAN_DEPOSIT_001', 'BASIC', '5년', 0.0205, '2025-01-01');

-- 신한은행 정기예금 금리 데이터 (상품유형 0: 디폴트옵션)
INSERT INTO shinhan_interest_rates (product_code, interest_type, maturity_period, interest_rate, effective_date) VALUES
('SHINHAN_DEPOSIT_002', 'BASIC', '3년', 0.0212, '2025-01-01');
