...
import com.hanainplan.shinhan.product.service.ProductSubscriptionService;
...
@RestController
@RequestMapping("/api/shinhan/product")
@Tag(name = "Shinhan 은행 상품 가입 관리", description = "금융상품 및 IRP 상품 가입 API")
