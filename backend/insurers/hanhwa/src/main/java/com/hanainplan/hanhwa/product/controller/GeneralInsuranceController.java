...
import com.hanainplan.hanhwa.product.service.GeneralInsuranceService;
...
@RestController
@RequestMapping("/api/hanhwa/general-insurance")
@RequiredArgsConstructor
@Tag(name = "Hanhwa 일반보험 상품 관리", description = "Hanhwa 보험사의 일반보험 상품 CRUD API")
