package com.hanainplan.samsung.customer.controller;
...
import com.hanainplan.samsung.customer.service.CustomerService;
...
@RestController
@RequestMapping("/api/samsung/customers")
@RequiredArgsConstructor
@Tag(name = "Samsung 고객 관리", description = "Samsung 보험사의 고객 CRUD API")
