...
import com.hanainplan.samsung.product.dto.GeneralInsuranceRequestDto;
import com.hanainplan.samsung.product.dto.GeneralInsuranceResponseDto;
import com.hanainplan.samsung.product.service.GeneralInsuranceService;
...
@RestController
@RequestMapping("/api/samsung/general-insurance")
@RequiredArgsConstructor
@Tag(name = "Samsung 일반보험 상품 관리", description = "Samsung 보험사의 일반보험 상품 CRUD API")
