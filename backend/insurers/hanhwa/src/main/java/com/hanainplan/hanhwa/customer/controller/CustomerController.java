package com.hanainplan.hanhwa.customer.controller;

import com.hanainplan.hanhwa.customer.dto.CustomerRequestDto;
import com.hanainplan.hanhwa.customer.dto.CustomerResponseDto;
import com.hanainplan.hanhwa.customer.service.CustomerService;
...
@RestController
@RequestMapping("/api/hanhwa/customers")
@RequiredArgsConstructor
@Tag(name = "Hanhwa 고객 관리", description = "Hanhwa 보험사의 고객 CRUD API")
