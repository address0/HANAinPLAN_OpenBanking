...
import com.hanainplan.hana.product.service.PensionInsuranceService;
...
@RestController
@RequestMapping("/api/hana/pension-insurance")
@RequiredArgsConstructor
@Tag(name = "HANA 연금보험 상품 관리", description = "HANA 보험사의 연금보험 상품 CRUD API")
