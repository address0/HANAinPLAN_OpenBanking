...
import com.hanainplan.hana.product.dto.ProductSubscriptionRequestDto;
import com.hanainplan.hana.product.dto.ProductSubscriptionResponseDto;
import com.hanainplan.hana.product.service.ProductSubscriptionService;
...
@RestController
@RequestMapping("/api/hana/product")
@Tag(name = "HANA 은행 상품 가입 관리", description = "금융상품 및 IRP 상품 가입 API")
