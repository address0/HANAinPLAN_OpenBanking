...
import com.hanainplan.kookmin.product.dto.FinancialProductRequestDto;
import com.hanainplan.kookmin.product.dto.FinancialProductResponseDto;
import com.hanainplan.kookmin.product.service.FinancialProductService;
...
@RestController
@RequestMapping("/api/kookmin/products")
@CrossOrigin(origins = "*")
