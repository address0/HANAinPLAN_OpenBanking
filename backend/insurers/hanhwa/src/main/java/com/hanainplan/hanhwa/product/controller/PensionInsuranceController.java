package com.hanainplan.hanhwa.product.controller;

import com.hanainplan.hanhwa.product.dto.PensionInsuranceRequestDto;
import com.hanainplan.hanhwa.product.dto.PensionInsuranceResponseDto;
import com.hanainplan.hanhwa.product.service.PensionInsuranceService;
...
@RestController
@RequestMapping("/api/hanhwa/pension-insurance")
@RequiredArgsConstructor
@Tag(name = "Hanhwa 연금보험 상품 관리", description = "Hanhwa 보험사의 연금보험 상품 CRUD API")
