  ...
  const depositProducts: DepositProduct[] = [
    {
      ...
      precautions: "중도해지시 일반예금금리 적용",
      contractCancellationRight: "계약일로부터 15일 이내",
      cancellationPenalty: "중도해지시 약정금리 미적용",
      paymentRestrictions: "없음",
      isActive: true,
    ...
    },
    {
      ...
      contractPeriodUnit: "개월",
      subscriptionTarget: "개인",
      subscriptionAmount: "50만원 이상",
      productCategory: "간편",
      interestPayment: "만기일시지급",
      taxBenefit: "이자소득세 15.4% 적용",
      partialWithdrawal: "불가",
      depositorProtection: "Y",
      transactionMethod: "인터넷뱅킹, 모바일뱅킹",
      precautions: "중도해지시 일반예금금리 적용",
      contractCancellationRight: "계약일로부터 15일 이내",
      cancellationPenalty: "중도해지시 약정금리 미적용",
      paymentRestrictions: "없음",
